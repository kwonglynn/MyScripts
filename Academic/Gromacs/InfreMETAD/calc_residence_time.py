...
with open('COLVAR-no-overlap', 'r') as fi:
    ...
    meta_time = metad_time * power(10, -3)          # Convet ps to ns
    resid_time = dt * sum_bias * power(10, -9)      # Convert ps to ms.

print "Metadynamics time: {:8.3f} ns".format(off_time)

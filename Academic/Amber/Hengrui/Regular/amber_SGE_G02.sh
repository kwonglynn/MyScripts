...
pmemd -O -i 01_Min.in -o 01_Min.out -p complex_wi.prmtop  -c complex_wi.inpcrd -r 01_Min.rst -ref complex_wi.inpcrd

#(2) Minimization with no restraints.
pmemd -O -i 02_Min.in -o 02_Min.out -p complex_wi.prmtop  -c 01_Min.rst -r 02_Min.rst

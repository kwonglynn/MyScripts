...
pmemd.cuda -O -i 01_Min.in -o 01_Min.out -p complex_wi_ZN.prmtop  -c complex_wi_ZN.inpcrd -r 01_Min.rst -ref complex_wi_ZN.inpcrd

#(2) Minimization with no restraints.
pmemd.cuda -O -i 02_Min.in -o 02_Min.out -p complex_wi_ZN.prmtop  -c 01_Min.rst -r 02_Min.rst

#(3) Heating with weak restraints.
pmemd.cuda -O -i 03_Heat.in -o 03_Heat.out -p complex_wi_ZN.prmtop -c 02_Min.rst -r 03_Heat.rst -ref 02_Min.rst -x 03_Heat.nc

#(4) Density Equilibration with weak restraints.
pmemd.cuda -O -i 04_Density.in -o 04_Density.out -p complex_wi_ZN.prmtop -c 03_Heat.rst -r 04_Density.rst -ref 03_Heat.rst -x 04_Density.nc

#(5) Production with no restraints.
pmemd.cuda -O -i 05_Prod.in -o 05_Prod.out -p complex_wi_ZN.prmtop -c 04_Density.rst -r 05_Prod.rst -x 05_Prod.nc
########################################################################################################################################
